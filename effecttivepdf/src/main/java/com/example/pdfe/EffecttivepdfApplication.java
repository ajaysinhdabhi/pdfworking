...
@RestController
public class EffecttivepdfApplication {

	public static void main(String[] args) {
		SpringApplication.run(EffecttivepdfApplication.class, args);
	}
	...
	HttpEntity<byte[]> createPdf(
		...
		Template t = ve.getTemplate("templates/testingproposed.vm");
	...
	public ByteArrayOutputStream generatePdf(String html) {
		...
		try {
			...
			document.addAuthor("ajaysinh");
			document.addAuthor("ajay123");
